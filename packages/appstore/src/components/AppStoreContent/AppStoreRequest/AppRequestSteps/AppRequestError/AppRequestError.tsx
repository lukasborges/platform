  ...
  return (
    <div className={classes.stepContent}>
      ...
      <div className={classes.text}>
        Please retry in couples of minutes or post topic in our <a target="_blank" href="https://github.com/lukasborges/platform/issues">Community</a> forum: we'll be there for you.
      </div>
    </div>
  );
};
